...
const config = defineConfig({
  theme: {
    ...
    semanticTokens: {
      colors: {
        bg: { value: "{colors.gray.600}" },
        "bg.subtle": { value: "{colors.gray.50}" },
        "bg.muted": { value: "{colors.gray.200}" },
        "bg.emphasized": { value: "{colors.gray.300}" },
        "bg.inverted": { value: "{colors.gray.800}" },
        ...
        "fg.inverted": { value: "{colors.gray.50}" },
        ...
        border: { value: "{colors.gray.950}" },
        "border.subtle": { value: "{colors.gray.900}" },
        "border.muted": { value: "{colors.gray.800}" },
        "border.emphasized": { value: "{colors.gray.300}" },
        "border.inverted": { value: "{colors.gray.800}" },
        ...
        "interactive.hover": { value: "{colors.gray.700}" },
        "interactive.active": { value: "{colors.gray.800}" },
        "interactive.disabled": { value: "{colors.gray.200}" },
        "interactive.textDisabled": { value: "{colors.gray.500}" },
        "interactive.focusRing": { value: "{colors.gray.400}" },
      },
      radii: {
        "2xs": { value: "{radii.2xs}" },
        xs: { value: "{radii.xs}" },
